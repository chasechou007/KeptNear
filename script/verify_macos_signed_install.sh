...
require_manifest_value "Release mode" "experimental-pre-release"
require_manifest_value "Distribution ready" "true"
require_manifest_value "Production ready" "false"
